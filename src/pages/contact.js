...
const StatusMessage = styled.p`
  ...
  color: ${({ type, theme }) =>
    type === FORM_STATUS.ERROR ? theme.palette.error : theme.palette.success};
  font-weight: ${({ theme }) => theme.fontWeight[1]};
`
...
const ContactPage = () => {
  ...
  return (
    <Layout>
      <Seo
        title="Get in Touch"
        description="Want to discuss a project you have in mind? I would love to hear from you! It all starts with a commitment free chat over a cup of tea..."
      />
      <Container>
        ...
        <ContactForm method="POST" onSubmit={handleSubmit}>
            ...
            <label htmlFor="email">
              ...
              >
                <g clipPath="url(#clip0)">
                  <path
                    d="M1.54102 4.48098L8.08141 8.84125C8.35385 9.02302 8.67403 9.12002 9.00154 9.12002C9.32906 9.12002 9.64923 9.02302 9.92167 8.84125L16.4621 4.48098H1.54102ZM3.19891 13.5994H14.8042C15.2439 13.5994 15.6656 13.4247 15.9765 13.1138C16.2874 12.8029 16.4621 12.3812 16.4621 11.9415V3.65204C16.4621 3.21233 16.2874 2.79064 15.9765 2.47973C15.6656 2.16881 15.2439 1.99414 14.8042 1.99414H3.19891C2.75921 1.99414 2.33752 2.16881 2.0266 2.47973C1.71569 2.79064 1.54102 3.21233 1.54102 3.65204V11.9415C1.54102 12.3812 1.71569 12.8029 2.0266 13.1138C2.33752 13.4247 2.75921 13.5994 3.19891 13.5994Z"
                    stroke="black"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          {formStatus === FORM_STATUS.ERROR && (
            <StatusMessage type={FORM_STATUS.ERROR}>
              Whoops, something has gone wrong while sending your message.
              <br />
              Please try again...
            </StatusMessage>
          )}
          {formStatus === FORM_STATUS.SUCCESS && (
            <StatusMessage type={FORM_STATUS.SUCCESS}>
              Yay! your message is on it's way to my inbox...
              <br />
              Thank you for getting in touch, I will get back to you within a
              few days.
            </StatusMessage>
          )}
          <Button
