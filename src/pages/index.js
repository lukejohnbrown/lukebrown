...
import { HandIcon, ServiceInfo } from "../components/home"
...
const IndexPage = () => (
  <Layout>
    ...
    <Container>
      ...
      <IntroText>
        These days, browsing the internet can feel like a bit of a chore. It
        seems as though every website you visit immediately hounds you with
        cookie notices and newsletter sign ups, resulting in a horrible user
        experience.
        <br />
        <br />
      ...
      <Services>
        ...
        <ServiceWrapper>
          <ServiceInfo title="Bespoke Website Design" icon={<DesignIcon />}>
            I love to work with business owners and individuals to create
            bespoke designs that suit their brand perfectly. I believe that
            there is more to a professional looking website than it simply
            “looking pretty”. Designing for the web requires consideration for
            every user that visits your site, which is why we always approach
            design by prioritising user experience and accessibility.
          </ServiceInfo>
        </ServiceWrapper>
