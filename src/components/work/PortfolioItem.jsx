...
const PortfolioImageWrapper = styled.div`
  position: relative;
  width: calc(100% + ${({ theme }) => theme.space[4]} + ${({ theme }) => theme.space[4]});
  margin: 0 -${({ theme }) => theme.space[4]};

  @media(min-width: 360px) {
    width: calc(100% + ${({ theme }) => theme.space[5]} + ${({ theme }) => theme.space[5]} );
